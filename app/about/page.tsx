          ...
          <div className="max-w-[1280px] mx-auto px-6 md:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
              <div className="lg:col-span-7">
                <motion.span {...fade} className="editorial-label">
                  About
                </motion.span>
                <motion.h1
                  {...fade}
                ...
                <motion.p
                  ...
                  className="text-[1.125rem] text-navy/60 leading-relaxed max-w-[540px] mb-6"
                >
                  {profile.intro}
                </motion.p>
                <motion.p
                  ...
                  className="text-[1.125rem] text-navy/60 leading-relaxed max-w-[540px]"
                >
                  ...
                  as CPTO, overseeing product strategy, architecture, and
                ...
                <div className="space-y-0">
                  {profile.recentSkills.map((skill, i) => (
                    <motion.div
                      ...
                      className="flex items-center gap-3 py-3 border-b border-navy/[0.04]"
                    >
                ...
                <div className="flex flex-wrap gap-2">
                  {profile.allSkills.map((skill, i) => (
                    <motion.span
                      ...
                      className="text-[0.8125rem] text-navy/40 border border-navy/[0.08] px-3 py-1.5 font-medium hover:text-navy/70 hover:border-navy/20 transition-all duration-300"
                    >
                      {skill}
                    </motion.span>
                  ))}
            ...
            <div className="space-y-0">
              {profile.experiences.map((exp, i) => (
                <motion.div
                  ...
                  className="border-b border-navy/[0.06]"
                >
                  <div className="py-8 md:py-10">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8">
                      <div className="md:col-span-3">
                        ...
                        {i === 0 && (
                          <span className="inline-block text-[0.6875rem] tracking-[0.1em] uppercase bg-navy text-white px-2 py-0.5 mt-2 font-medium">
                            Current
                          </span>
                        )}
                      </div>
                        ...
                        {exp.promotion.map((role, j) => (
                          <div key={role.title} className={j > 0 ? "pt-6 border-t border-navy/[0.04]" : ""}>
                            <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 mb-3">
                              <h4 className="font-[family-name:var(--font-heading)] text-navy font-bold text-[1rem]">
                                {role.title}
                              </h4>
                              <span className="text-[0.8125rem] text-navy/35 font-medium shrink-0">
                                {role.year}
                              </span>
                            </div>
                            <ul className="space-y-1.5">
                              {role.summary.map((item) => (
                                <li
                                  key={item}
                                  className="flex items-start gap-3 text-[0.9375rem] text-navy/50"
                                >
        ...
        <section className="py-20 md:py-28 text-center">
          <div className="max-w-[560px] mx-auto px-6">
            ...
            <p className="text-navy/50 text-[1.0625rem] mb-10">
              Looking for a strategic tech partner? Let&apos;s talk about how
