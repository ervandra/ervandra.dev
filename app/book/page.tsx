            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
              <div className="lg:col-span-5">
                ...
                <motion.p
                  ...
                  className="text-[1.0625rem] text-navy/50 leading-relaxed mb-10"
                >
                  30 minutes to discuss your business goals, technology
                  challenges, and how I can help. No obligation, no sales pitch
                  &mdash; just an honest conversation.
                </motion.p>
                ...
                <motion.div
                  ...
                  className="mt-12 p-6 bg-warm-gray/50 border border-navy/[0.06]"
                >
                  <p className="text-[0.8125rem] text-navy/30 uppercase tracking-[0.1em] font-semibold mb-3">
                    What we&apos;ll cover
                  </p>
                  <ul className="space-y-2">
                    {[
                      "Your current business & technology landscape",
              ...
              >
                <div className="bg-white border border-navy/[0.08] min-h-[600px] flex items-center justify-center">
                  <iframe
                    src="https://calendly.com/ervandra/free-strategy?hide_gdpr_banner=1&background_color=ffffff&text_color=0a192f&primary_color=0a192f"
                    width="100%"
                    height="700"
                    frameBorder="0"
