const profile = {
  ...
  mission: 'Strategic Tech Partner',
  email: 'hi@ervandra.com',
  phone: '+6287708770800',
  photo: 'https://www.ervandra.com/wp-content/uploads/2020/12/ervan-round.png',
  about:
    "I help businesses align technology with growth. Through system audits, fractional CTO partnerships, AI implementation, and premium development — I don't just build, I partner.",
  intro:
  ...
  caseStudies: [
    ...
    {
      company: 'R/GA',
      challenge: 'Global agency needed senior technical leadership to deliver complex digital experiences for Fortune 500 brands.',
    ...
    {
      company: 'CIAYO Comics',
      challenge: "Startup needed to build a digital comics platform from zero and scale it in Indonesia's growing digital content market.",
      impact: '656,000 registered users. One of Indonesia\'s leading comics platforms.',
      role: 'Co-founded the tech side. Led frontend team from first line of code through full scale.',
    },
    {
      company: 'LifeLearn Holdings',
      challenge: 'Finnish education company struggled with an outdated backend that consumed engineering time instead of enabling growth.',
  ...
  trustedBy: ['Syntax', 'R/GA', 'MTF', 'Komunal', 'CIAYO', 'LifeLearn', 'DDTC', 'Paper.id'],
  testimonials: [
    {
      name: 'Jussi Hurmola',
